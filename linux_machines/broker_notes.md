...
Searching for ActiveMQ exploits I find:
...
There is a way to exploit this further to get a reverse shell from nginx as root, but I chose to just grab the flag using the exploit. Alternatively, if you were feeling very lazy, you can access both flags from http://10.10.11.243:1338/ which is inexplicably hosting all files.
